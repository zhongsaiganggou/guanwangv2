...
- Never lift from random points on the member — this can cause deformation or damage
...
- Do not force members into position — this can cause damage or residual stress
...
### Inspection Stages
1. **Foundation inspection** — before steel erection begins
2. **In-process inspection** — during installation, checking alignment, bolting, and welding
3. **Final structural inspection** — after all structural steel is in place
4. **Connection inspection** — verify all bolts are torqued, welds are complete
5. **Handover inspection** — before cladding or other trades proceed
...
1. **Thorough preparation** — site readiness, foundation inspection, and delivery planning
2. **Proper lifting** — correct crane selection, lifting points, and weather awareness
3. **Logical sequence** — columns first, then primary beams, then secondary members
4. **Connection quality** — correct bolts, proper torque, qualified welding
5. **Alignment control** — regular plumb, level, and dimension checks
6. **Safety first** — PPE, fall protection, and lifting safety at all times
7. **Clear coordination** — communication between supplier, contractor, and owner
8. **Complete documentation** — inspection records, test reports, and as-built drawings
